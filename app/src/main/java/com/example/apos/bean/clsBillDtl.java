...
public class clsBillDtl {
    ...
    String strKOTTimeDifferenceResult;
    ...
    public String getStrKOTDate() {
        return strKOTDate;
    }

    public void setStrKOTDate(String strKOTDate) {
        this.strKOTDate = strKOTDate;
    }
    ...
    public String getStrKOTTimeDifferenceResult() {
        return strKOTTimeDifferenceResult;
    }

    public void setStrKOTTimeDifferenceResult(String strKOTTimeDifferenceResult) {
        this.strKOTTimeDifferenceResult = strKOTTimeDifferenceResult;
    }
