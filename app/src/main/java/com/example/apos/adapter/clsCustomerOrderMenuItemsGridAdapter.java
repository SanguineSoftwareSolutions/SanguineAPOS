...
public class clsCustomerOrderMenuItemsGridAdapter extends BaseAdapter {
    ...
    public clsCustomerOrderMenuItemsGridAdapter(Context context, Activity activity, List<clsKotMenuItemsBean> menuItemsData, clsKotMenuItemSelectionListener mMenuItemSelectionListener) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        rowView = inflater.inflate(R.layout.customerordermenulistforadapter, null);
        ...
        String imageString=menuItemBean.getStrItemImage();
        if(imageString.equals("Image Not Found"))
        {
           // holder.ivMenuItemImage.setImageResource(R.mipmap.noimageicon);
        }
        else {
            byte[] decodedString = Base64.decode(imageString, Base64.DEFAULT);
            Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            holder.ivMenuItemImage.setImageBitmap(decodedByte);
        }
