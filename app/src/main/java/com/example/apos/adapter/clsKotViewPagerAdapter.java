...
public class clsKotViewPagerAdapter extends FragmentStatePagerAdapter {
	...
	public clsKotViewPagerAdapter(FragmentManager fm, CharSequence mTitles[], int mNumbOfTabsumb, ViewPager viewPager) {
		super(fm);
	...
	public Fragment getItem(int position) {
		...
		switch (position) {
			case 0:
				return clsKotTable.getInstance();
			case 1:
				return clsKotWaiter.getInstance();
			case 2:
				return clsKotItemListFragment.getInstance();
			case 3:
				return new clsKotMenuItemFragment();
			case 4:
				return clsPaxFragment.getInstance();
			case 5:
				return clsKotOtherOptionsFragment.getInstance();
		}
		return null;
	}
