...
import com.example.apos.activity.clsTakeAwayScreen;
...
public class clsTakeAwayItemListFragment extends Fragment implements clsDirectBillerItemListSelectionListener{
    ...
    private String tableNo,waiterNo,tableAreaCode;
    private Button btnAllItemsListRetrieve;
    ...
    private String strMenuItemCode, strMenuItemName;
    private clsGlobalFunctions objglobal;
    private  String keyCase="upperCase";
    private clsTakeAwayActListener objTakeAwayActListener;
    private ConnectivityManager connectivityManager;
    private Dialog pgDialog;
    Activity mActivity;
    ImageView imvRefresh;
    public static clsTakeAwayItemListFragment getInstance()
    {
        clsTakeAwayItemListFragment mClsTakeAwayItemListFragment = new clsTakeAwayItemListFragment();
        return mClsTakeAwayItemListFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        try
        {
            objItemListSelectionListener = (clsDirectBillerItemListSelectionListener) clsTakeAwayItemListFragment.this;
            objTakeAwayActListener=(clsTakeAwayActListener)getActivity();
        }
        catch (Exception ex)
        {
            ...
            public void onClick(View v) {
                if (new clsUtility().isInternetConnectionAvailable(connectivityManager))
                {
                    ...
                    if (clsGlobalFunctions.gCounterWiseBilling.equals("Yes")) {
                        new clsTakeAwayItemListFragment().funGetItemPriceDtlCounterWise("All");
                    } else {
                        //new clsTakeAwayItemListFragment().funGetItemPriceDtl("All");
     ...
     private static void funSetList(ArrayList arrList)
    {
        clsDirectBillItemsListGridViewAdapter DirectBillItemsListGridViewAdapter
                = new clsDirectBillItemsListGridViewAdapter(clsTakeAwayScreen.mActivity, clsTakeAwayScreen.mActivity, arrList, objItemListSelectionListener);
    ...
    {
        if (clsGlobalFunctions.gCounterWiseBilling.equals("Yes")) {
            new clsTakeAwayItemListFragment().funGetItemPriceDtlCounterWise(strMenuItemCode, strMenuType);
        } else {
           // new clsTakeAwayItemListFragment().funGetItemPriceDtl(strMenuItemCode, strMenuType);
            funGetItemPricingDtl(strMenuType,strMenuItemCode);
        }
       // new  MenuItemPriceListWS().execute(strMenuItemCode,strMenuType);
    ...
    {
        objTakeAwayActListener.funRefreshItemDtl(strItemCode, strItemName, strSubGroupCode, dblSalePrice);
        edtItemListSearch.setText("");
    ...
    protected void showDialog() {
        if (null == pgDialog ) {
            if(mActivity ==null)
                mActivity=clsTakeAwayScreen.mActivity;
