...
public class clsTakeAwayClsMenuItemFragment extends Fragment implements clsMenuItemSelectionListener{
    ...
    private static ArrayList arrListMenuItemMaster;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        try
        {
            menuItemSelectionListener = (clsMenuItemSelectionListener) clsTakeAwayClsMenuItemFragment.this;
    ...
    {
        gvMenuItems.setAdapter(new clsDirectBillMenuItemsGridAdapter(clsTakeAwayScreen.mActivity, clsTakeAwayScreen.mActivity, arrList, menuItemSelectionListener));
    ...
    {
        objTakeAwayActListener.setMenuItemSelectionCodeResult(strMenuItemCode, strMenuItemName,strMenuType);
        edtMenuSearch.setText("");
